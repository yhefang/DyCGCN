...
def extract_time_windows(stock_data, adj, feature_to_ind, time_steps):
    ...
    Returns:
        ...
        label:(date, node)
    """
    x_stock_data_indices = [feature_to_ind['OpenPrice'], feature_to_ind['HighPrice'], feature_to_ind['LowPrice'], feature_to_ind['Amount']]
    x_stock_data = stock_data[x_stock_data_indices, :, :]

    closing_price = stock_data[feature_to_ind['ClosePrice'], :-time_steps, :]
...
def get_parser(data_type):
    ...
    if data_type == 'HKEXtoSSE':
        ...
        # ============================================================================================================
        # parser.add_argument("--output_dir", type=str, default="data/HKEXtoSSE", help="Output directory.")
        # parser.add_argument("--adj_filename", type=str, default="data/adj_mx/dyadjmx_amount_HKEXtoSSE.pkl.npz")
        # ============================================================================================================
        # parser.add_argument("--output_dir", type=str, default="data/t=1/SSE", help="Output directory.")
        # parser.add_argument("--adj_filename", type=str, default="data/t=1/SSE/dyadjmx_amount_HKEXtoSSE_t=1.pkl.npz")
        # ============================================================================================================
        parser.add_argument("--output_dir", type=str, default="data/casestudy", help="Output directory.")
        parser.add_argument("--adj_filename", type=str, default="data/casestudy/dyadjmx_amount_HKEXtoSSE.pkl.npz")
